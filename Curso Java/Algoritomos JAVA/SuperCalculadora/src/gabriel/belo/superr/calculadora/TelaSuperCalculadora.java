...
package gabriel.belo.superr.calculadora;


public class TelaSuperCalculadora extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TelaSuperCalculadora.class.getName());
    ...
    private void btnCalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalActionPerformed
        ...
        double res = v %2;
        float ele = (float)Math.pow(3 , v);
        float qua = (float)Math.sqrt(v);
        float cu = (float)Math.cbrt(v);
        double ab = Math.abs(v);
        
        
        
        lblRes.setText(Double.toString(res));
        lblEle.setText(Float.toString(ele));
        lblQua.setText(Float.toString(qua));
        lblCu.setText(Float.toString(cu));
        lblAbs.setText(Double.toString(ab));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new TelaSuperCalculadora().setVisible(true));
    }
